...
ProjectPath            :=C:/dev/C/Workspace/Challenge9
...
$(IntermediateDirectory)/Weather.c$(ObjectSuffix): Weather.c $(IntermediateDirectory)/Weather.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/dev/C/Workspace/Challenge9/Weather.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Weather.c$(ObjectSuffix) $(IncludePath)
