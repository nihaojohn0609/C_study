...
ProjectPath            :=C:/dev/C/Workspace/PointerBasics
IntermediateDirectory  :=../build-$(WorkspaceConfiguration)/PointerBasics
...
Objects0=$(IntermediateDirectory)/Pointer.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/Pointer.c$(ObjectSuffix): Pointer.c $(IntermediateDirectory)/Pointer.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/dev/C/Workspace/PointerBasics/Pointer.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Pointer.c$(ObjectSuffix) $(IncludePath)
