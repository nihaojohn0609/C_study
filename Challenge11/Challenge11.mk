...
ProjectPath            :=C:/dev/C/Workspace/Challenge11
...
$(IntermediateDirectory)/TicTacToe.c$(ObjectSuffix): TicTacToe.c $(IntermediateDirectory)/TicTacToe.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/dev/C/Workspace/Challenge11/TicTacToe.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/TicTacToe.c$(ObjectSuffix) $(IncludePath)
